...
if config_path is not None:
    ...
    LEVEL2_DRP_CONFIG_COLUMNS = pd.read_csv(config_path / "L2-DRP_CONFIG-columns.csv")
    LEVEL2_ORDER_TABLE_COLUMNS = pd.read_csv(config_path / "L2-ORDER_TABLE-columns.csv")
    ...
    LEVEL2_DRP_CONFIG_COLUMNS = None
    LEVEL2_ORDER_TABLE_COLUMNS = None
